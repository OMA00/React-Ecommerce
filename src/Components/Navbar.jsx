...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    // Apply solid nav whens scrolled past threshold on home
    if (!isHome) {
      setSolid(false);
    }

    const onScroll = () => {
      setSolid(window.onscrollY > 10);
    };
  ...
  const LinkClass = (to) =>
    `block py-2 hover:text-smGreen hover-underline underline-offset-4 transitions-colors ${
